<template>
    <div class="searchTop">
        <div class="searchTopNav">
            ...
            <div class="right">
                <input type="text" v-model="txt"  @keyup.enter='seach' @blur="seach">
            </div>
        </div>
        <div class="searchSongs">
            <div class="searchSongs-top">
                <div class="left" @click="bfsearch">
                    <svg class="icon" aria-hidden="true">
    ...
    methods:{
        async seach(){
            ...
            if(this.txt==''){
                ...
                var res = await getsearch(this.txt)
        ...
        setplay(item){
            ...
            store.commit('addgq',item)
        },
        bfsearch(){
            for(var i=0;i<this.songs.length;i++){
                this.songs[i].al=this.songs[i].album
                this.songs[i].al.picUrl=this.songs[i].album.artist.img1v1Url
            }
            store.commit('setPlayList',this.songs)
        }
    },
    // async updated(){
    //     console.log(this.txt)
